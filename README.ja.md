...
![アーキテクチャ概要](docs/images/architecture_overview.svg)
...
| アプリケーション層でのテナント分離 | マルチテナント用 gem [acts_as_tenant](https://github.com/ErwinM/acts_as_tenant) により、ActiveRecord のクエリに自動でテナント条件を付加 |
